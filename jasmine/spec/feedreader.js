...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('can be looped through', function() {
    ...
    describe('The menu', function() {
        ...
        it('is hidden by default', function() {
         ...
         it('visibility changes on click', function() {
             let buttonOpen = document.querySelector('.menu-icon-link');
             expect(document.querySelector('body').className).toBe('menu-hidden');
             buttonOpen.click();
    ...
    describe('Initial Entries', function() {
        ...
        it('should load at least one feed', function(done) {
            expect(document.querySelector('.feed').children[0].querySelector('.entry')).toBeDefined();
            done();
        });
    });
    ...
    describe("New Feed Selection", function() {
        ...
        it('content is loaded and updated', function(done) {
